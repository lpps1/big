 ...
 * 2. Price
 * 3. Date of Transfer (Format yyyy-mm-dd, hh:mm)
 * 4. Postcode
 * 5. Property Type
 * 6. Old/New
 * 7. Duration
...
public class CountyMapper extends Mapper<LongWritable, Text, Text, Text>{
...
//	2015-06-01 00:00
	private final String DATE_TIME_FORMAT_PATTERN_1 = "yyyy";
...
//							2015-06-01 00:00
						System.out.println("Date of Transfer:" + dateOfTransfer);
						int year=0;
						SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-mm-dd HH:mm");
						try {
							Date date = simpleDateFormat.parse(dateOfTransfer);
						...
						context.write(new Text(county), new Text(String.valueOf(year + "###" + priceInteger)));
					}
				}
			}
		}
